...
urlpatterns = [
    ...
    re_path(r'^enter-data/(?P<curate_data_structure_id>\w+)/(?P<reload_unsaved_changes>\w+)$',
            user_registry_views.EnterDataRegistryView.as_view(),
            name='core_curate_enter_data'),
    re_path(r'^view-data/(?P<curate_data_structure_id>\w+)$', user_registry_views.ViewDataRegistryView.as_view(),
            name='core_curate_view_data'),
    re_path(r'^download-xml/(?P<curate_data_structure_id>\w+)$', user_views.download_current_xml,
            name='core_curate_download_xml'),
    re_path(r'^download-xsd/(?P<curate_data_structure_id>\w+)$', user_views.download_xsd,
            name='core_curate_download_xsd'),
    re_path(r'^generate-choice/(?P<curate_data_structure_id>\w+)$', user_ajax.generate_choice,
            name='core_curate_generate_choice'),
    re_path(r'^generate-element/(?P<curate_data_structure_id>\w+)$', user_ajax.generate_element,
    ...
    re_path(r'^cancel-changes$', user_ajax.cancel_changes,
            name='core_curate_cancel_changes'),
    re_path(r'^cancel-form$', user_ajax.cancel_form,
            name='core_curate_cancel_form'),
    re_path(r'^save-form$', user_ajax.save_form,
            name='core_curate_save_form'),
    re_path(r'^save-data$', user_ajax.save_data,
            name='core_curate_save_data'),
    re_path(r'^validate-form$', user_ajax.validate_form,
            name='core_curate_validate_form'),
    re_path(r'^view-form/(?P<curate_data_structure_id>\w+)$',
